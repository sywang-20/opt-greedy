...
def run_case(size):
    ...
    for i in range(count):
        ...
        evo = Evolution(problem, search_steps=search_steps, num_of_individuals=num_of_individuals, fig_path=fig_path,
                        node_num=node_num)
...
if __name__=='__main__':
    ...
    #parser.add_argument("--outdir", type=str,default="../../../TESTOUTPUT/local_search/greedy_nondominated_parameter_latest/")  # 对应输出结果的保存目录
    ...
    run_case(search_steps, num_of_individuals, size)
